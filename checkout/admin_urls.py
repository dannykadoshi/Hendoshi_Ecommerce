...
urlpatterns = [
    ...
    path('discount-codes/<int:code_id>/toggle/', admin_views.admin_discount_codes_toggle, name='admin_discount_codes_toggle'),  # noqa: E501
    path('discount-codes/<int:code_id>/delete/', admin_views.admin_discount_codes_delete, name='admin_discount_codes_delete'),  # noqa: E501
    ...
    path('shipping/<int:ship_id>/toggle/', admin_views.admin_shipping_toggle_active, name='admin_shipping_toggle_active'),  # noqa: E501
    path('shipping/<int:ship_id>/set-standard/', admin_views.admin_shipping_set_standard, name='admin_shipping_set_standard'),  # noqa: E501
